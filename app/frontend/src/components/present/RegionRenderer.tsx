      ...
      switch (content.type) {
        ...
        case "richtext":
          // Strip any HTML tags and render as markdown
          {
            ...
            // Strip all markup robustly via the DOM parser; the previous regex
            // (/<[^>]*>/g) is incomplete for nested/malformed tags. ReactMarkdown
            // then renders the plain text without interpreting raw HTML.
            const cleanText =
              new DOMParser().parseFromString(rawText, "text/html").body
                .textContent || "";
            return (
              <div
