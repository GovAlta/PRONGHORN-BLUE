...
import ReactFlow, { Node, Edge, Background, Controls, MarkerType, Position, useNodesState, useEdgesState, Handle } from "reactflow";
import "reactflow/dist/style.css";
import { Key, Plus, ArrowDownToLine, AlertTriangle, Minus, LayoutGrid } from "lucide-react";
...
export const DatabaseErdView: React.FC<DatabaseErdViewProps> = ({
  ...
  const { initialNodes, initialEdges } = useMemo(() => {
    ...
    new Set(importTables.map(t => t.name.toLowerCase()));
