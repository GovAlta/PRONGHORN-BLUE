...
export function ConnectionStringDialog({
  ...
  // Render API returns: internalConnectionString, externalConnectionString, password, psqlCommand
  // Schema-provisioned DBs return: connectionString, externalConnectionString, password, psqlCommand
  ...
  const externalConnectionString = connectionInfo.externalConnectionString || connectionInfo.connectionString || "";
