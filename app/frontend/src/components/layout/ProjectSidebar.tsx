import { ListTree, Layout, ShieldCheck, Hammer, FileText, Settings as SettingsIcon, X, Archive, MessageSquare, GitBranch, Rocket, Database, ClipboardCheck, Presentation } from "lucide-react";
...
const experimentalNavItems = [
  ...
  { icon: Presentation, label: "Present", path: "present" },
];
