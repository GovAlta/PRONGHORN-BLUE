...
export function SuperadminCloudManager({ type }: SuperadminCloudManagerProps) {
  ...
  const fetchResources = async () => {
    ...
    try {
      ...
      const { data, error } = await pronghornApi.functions.invoke("superadmin-cloud-management", {
  ...
  const handleAction = async (
    ...
    try {
      ...
      const { error } = await pronghornApi.functions.invoke("superadmin-cloud-management", { body });
      if (error) throw error;
