...
export function SuperadminGitHubManager() {
  ...
  const fetchRepos = async () => {
    ...
    try {
      ...
      const { data, error } = await pronghornApi.functions.invoke("superadmin-github-management", {
  ...
  const performDelete = async (repo: GitHubRepo) => {
    try {
      const { error } = await pronghornApi.functions.invoke("superadmin-github-management", {
