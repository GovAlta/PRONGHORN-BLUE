...
export function CreateRepoDialog({
  ...
  const defaultOrg = import.meta.env.VITE_GITHUB_ORG || "";
  const [templateOrg, setTemplateOrg] = useState(defaultOrg);
        ...
        <Tabs defaultValue="empty">
          ...
          <TabsContent value="empty" className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">Will be created in {defaultOrg} account</p>
            </div>
