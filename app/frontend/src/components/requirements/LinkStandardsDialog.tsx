...
export function LinkStandardsDialog({ open, onClose, requirementId, requirementTitle, shareToken }: LinkStandardsDialogProps) {
  ...
  const loadData = async () => {
    ...
    const { data: linkedData } = await pronghornApi.rpc("get_requirement_standards_with_token", {
  ...
  const handleLinkStandard = async (standardId: string) => {
    ...
    try {
      if (isLinked) {
        ...
        const { data: existingLinks } = await pronghornApi.rpc("get_requirement_standards_with_token", {
          p_requirement_id: requirementId,
          p_token: shareToken || null
        });
        ...
        await pronghornApi.rpc("delete_requirement_standard_with_token", {
