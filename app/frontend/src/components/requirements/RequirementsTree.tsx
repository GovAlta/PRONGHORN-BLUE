...
function RequirementNode({ requirement, level = 0, projectId, shareToken, expandAll, onUpdate, onDelete, onAdd, onExpand, onLinkStandard }: any) {
  ...
  const handleAIExpand = async () => {
    ...
    setIsExpanding(true);
    try {
      const { data, error } = await pronghornApi.functions.invoke("expand-requirement", { 
        body: { 
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <RequirementStandardsBadges requirementId={requirement.id} projectId={projectId} shareToken={shareToken} />
