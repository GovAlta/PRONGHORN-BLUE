...
import { Brain, Wrench, MessageSquare, AlertCircle, ArrowRight, Plus, FileText, Loader2, CheckCircle2, XCircle, ChevronDown, ChevronRight, Link2, Layers, List, FileSearch, Pencil } from "lucide-react";
