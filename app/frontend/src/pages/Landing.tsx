...
import { FileText, Library, Layout, Bot, Code, Users, ArrowRight, Check, ShieldCheck, GitBranch, CheckCircle, Rocket, Shield, Award, Settings, Archive, MessageSquare, ListTree, Hammer, Sparkles, Github, Heart, Zap, ChevronLeft, ChevronRight, Database, BookOpen, Download, Layers, Cpu } from "lucide-react";
...
export default function Landing() {
  ...
  const workflowSteps = [{
    ...
    aiDetails: {
      ...
      capabilities: ["Select from 20+ models including GPT-5, GPT-4.1, o3, DeepSeek, Llama, and Phi-4", "Configure max tokens and response length limits", "Enable extended thinking mode for reasoning models (o-series, Phi reasoning)", "Azure AI Foundry powered with enterprise security"]
    }
  }, {
    icon: Archive,
    label: "Artifacts",
    ...
    aiDetails: {
      ...
      capabilities: ["AI agents with full project context awareness", "Can read requirements, standards, canvas, and files", "Azure AI Foundry models (GPT-4o, GPT-4.1, o3)", "Attach any project element as conversation context"]
    }
  }, {
    icon: ListTree,
    label: "Requirements",
    ...
    description: "Generate 10+ document types",
    phase: "design",
    hasAgent: true,
    aiDetails: {
      title: "AI Document Generation",
      capabilities: ["10+ specification templates for any audience", "Technical specs, executive summaries, procurement docs", "Azure cloud architecture guides", "Security review and compliance documentation"]
    }
  }, {
    icon: GitBranch,
    label: "Repository",
    ...
    aiDetails: {
      ...
      capabilities: ["Deploy to Azure Container Apps cloud hosting", "Local development runner with hot reload", "Environment-based deployments (dev/uat/prod)", "Bug telemetry integration for automated fixes"]
    }
  }];
  ...
  const benefits = ["Complete traceability from standards to code", "AI teams that iterate until architecture stabilizes", "No account required to start—instant collaboration", "Built-in code editor with GitHub sync", "Azure AI Foundry with enterprise-grade security", "10+ specification templates for any audience", "Database provisioning with AI-powered data import"];
            ...
            <Card className="public-card p-8 rounded-2xl hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm public-text-subtle">10+ specification templates</p>
                </div>
              </div>
          ...
          <div className="relative h-[450px] w-full rounded-3xl overflow-hidden shadow-2xl public-gradient-dark p-10 flex flex-col justify-center">
            ...
            <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-semibold text-white tracking-tight">20+</div>
                  <div className="text-white/70">AI Agents</div>
                  <div className="text-white/50 text-xs">Varies by deployment</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center">
