# =============================================================================
# PBMM Landing Zone Environment Variables - UAT
# =============================================================================
# PBMM-compliant configuration for the UAT environment. Deployed by pushing to
# the `uat` branch (deploy.yml selects params/uat.tfvars and GitHub Environment
# `uat`).
#
# INSTRUCTIONS:
...
#
# Usage:
#   terraform plan  -var-file="params/uat.tfvars"
#   terraform apply -var-file="params/uat.tfvars"
# =============================================================================

# ── Azure Configuration ──────────────────────────────────────────────────────

resource_group_name = "goa-cc-pronghorn_uat-rg"
...
postgresql_server_name   = "goa-cc-prongblue-uat-pbmm-psql"
...
postgresql_genapps_server_name         = "goa-cc-prongblue-uat-genapps-psql"
...
workload_aca_environment_name = "goa-cc-pronghorn-uat-workload-cae-001"
...
apim_api_name             = "pronghorn-uat-api"
apim_api_display_name     = "Pronghorn UAT API"
apim_api_path             = "api"
...
# ── Container Registry ───────────────────────────────────────────────────────
acr_name                  = "goaccprongblueuatacr" # REPLACE: globally-unique ACR name
...
# resource_group_name.
platform_resource_group_name = "goa-cc-pronghorn_uat-rg"
...
ai_foundry_project_name          = "pronghorn-uat-pbmm"
ai_foundry_project_description   = "Pronghorn AI uat project"
